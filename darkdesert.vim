...
" this is an edited version of desert made a little bit more dark
...
if s:t_Co >= 256
  ...
  hi StatusLine ctermfg=236 ctermbg=101 cterm=bold
  hi StatusLineNC ctermfg=242 ctermbg=101 cterm=NONE
  hi StatusLineTerm ctermfg=236 ctermbg=144 cterm=NONE
  hi StatusLineTermNC ctermfg=231 ctermbg=144 cterm=NONE
  hi VertSplit ctermfg=242 ctermbg=101 cterm=NONE
  ...
  hi TabLine ctermfg=236 ctermbg=101 cterm=NONE
  hi TabLineFill ctermfg=NONE ctermbg=101 cterm=NONE
  ...
  hi NonText ctermfg=81 ctermbg=234 cterm=NONE
